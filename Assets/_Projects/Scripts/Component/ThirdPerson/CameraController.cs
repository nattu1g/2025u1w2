...
*/
namespace Scripts.Component.ThirdPerson
{
    /// <summary>
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        [LabelText("縦カメラ回転制限")]
        public Vector2 cameraLimitX = new Vector2(-45, 40);
        [LabelText("横カメラ回転制限")]
        public Vector2 cameraLimitY = new Vector2(-45, 40);
        ...
        void Update()
        {
            ...
            // カメラを横（Y軸）にも回したい場合は、下のコードを活かすようにする
            mouseX += Input.GetAxis("Mouse X") * sensitivity;
            mouseY += Input.GetAxis("Mouse Y") * sensitivity;
            // Apply camera limts
            mouseX = Mathf.Clamp(mouseX, cameraLimitY.x, cameraLimitY.y);
            mouseY = Mathf.Clamp(mouseY, cameraLimitX.x, cameraLimitX.y);
